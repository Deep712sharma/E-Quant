...
def get_model():
    ...
    model = load_model_from_config(config, "./mainldm/models/ldm/lsun-churches256/model.ckpt")
    return model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--entropy_models_path", type=str, default="./entropy_models_church.pth",
