...
def extract_features(args):
        ...
        (interval_seq, all_cali_data, all_t, all_cali_t, all_cache) = torch.load("./calibration/celeba{}_cache{}_{}.pth".format(args.ddim_steps, args.replicate_interval, args.mode))
